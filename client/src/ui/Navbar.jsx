...
export default function Navbar() {
	...
	return (
		<nav className={clsx(
			"w-full flex flex-wrap justify-between items-center sticky top-0 z-40 py-3 px-4 bg-purple-100 border-b border-gray-300 backdrop-filter backdrop-blur-lg shadow-sm md:py-1"
		)} ref={navbarRef}>
			<div className="flex justify-between items-center md:mx-0">
				<Link to="/">
					<h3 className="text-medium text-2xl">MYNTRA TRENDS</h3>
				</Link>
			</div>
